...
Options:
    ...
    -o|--maxOuterLen	INT	The max allowed outer distance for pair-end reads (NOTE: tophat1.2 doesn't offer the outer distance in
				the 9th column. Use this option only for tophat2)
